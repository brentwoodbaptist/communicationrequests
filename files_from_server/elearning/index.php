...
<html lang="en">
	<head>
        ...
        <title>E-Learning Video Request Form // Brentwood Baptist Communications</title>
    ...
    <body>
    	<header>
        	<div class="centercontent">
            	<img src="../reporting/images/request_logo.png" class="logo">
...
<a href="mailto:adye@yourchurch.com" class="darkened">Tech [tech@yourchurch.com]</a>
        ...
        <section id="maincontent">
        	<div class="centercontent">
                ...
                <h2>E-Learning & E-Training Video Request</h2>

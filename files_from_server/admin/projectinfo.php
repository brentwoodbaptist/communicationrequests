...
<html lang="en">
    ...
    <body>
        ...
        <nav id="subnav">
          ...
          <a href="index.php" class="statusnav">New</a>
          <a href="index.php?status=3" class="statusnav">In Process</a>
          <a href="index.php?status=2" class="statusnav">On Hold</a>
          <a href="index.php?status=4" class="statusnav">Completed</a>
          <a href="index.php?status=5" class="statusnav">Canceled</a>
                <div class="clear"></div>
              </div>
          </div>
        </nav>
...
<?php do { ?>
  ...
  <?php } else if ($row_Recordset2['type']==5 || $row_Recordset2['type']==8){?>
  <tr><td class="descriptor">Type:</td><td class="information typeinfo">
  <?php if ($row_Recordset2['type']==5) { ?>
    <img src="../images/reprintimage.png" width="20" height="20" />
    <?php } else if ($row_Recordset2['type']==8) { ?>
    <img src="../images/signimage.png" width="20" height="20" />
	<?php } ?>
	<?php echo $row_Recordset2['typename']; ?></td></tr>
  <tr><td class="descriptor">Status:</td><td class="information"><?php echo $row_Recordset2['statusname']; ?></td></tr>
  ...
  <?php } else if ($row_Recordset2['type']==6 || $row_Recordset2['type']==7 || $row_Recordset2['type']==9 || $row_Recordset2['type']==10){?>
  <tr><td class="descriptor">Type:</td><td class="information typeinfo">
  <?php if ($row_Recordset2['type']==6) { ?>
    ...
    <?php } else if ($row_Recordset2['type']==9) { ?>
    <img src="../images/storyimage.png" width="20" height="20" />
    <?php } else if ($row_Recordset2['type']==10) { ?>
    <img src="../images/videoimage.png" width="20" height="20" />
	<?php } ?>
	<?php echo $row_Recordset2['typename']; ?></td></tr>
  <tr><td class="descriptor">Status:</td><td class="information"><?php echo $row_Recordset2['statusname']; ?></td></tr>
  <tr><td class="descriptor">Due Date:</td><td class="information"><?php echo $display_date; ?></td></tr>

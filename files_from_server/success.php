...
<html lang="en">
	<head>
        ...
        <title>Comm Req Complete // Brentwood Baptist Communications</title>
    ...
    <body>
    	<header>
        	<div class="centercontent">
            	<a href="http://www.commreq.com"><img src="reporting/images/commreq_logo.png" class="logo"></a>
...
<a href="mailto:lchaudhry@brentwoodbaptist.com" class="darkened">Laura Chaudhry [lchaudhry@brentwoodbaptist.com]</a>
        ...
        <section id="maincontent">
        	<div class="centercontent">
                ...
                <h2>Comm Req #<?php echo $projectnumber; ?> Submission Successful</h2>
                <div class="textcontainer">
                	<p><strong>A confirmation email has been sent to <?php echo $row_Recordset1['email']; ?>. If you do not receive it, please contact the project manager (projectmanager@brentwoodbaptist.com).</strong></p>
                </div>
